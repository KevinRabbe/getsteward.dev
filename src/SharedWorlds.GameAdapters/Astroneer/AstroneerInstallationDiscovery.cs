...
internal static partial class AstroneerInstallationDiscovery
{
    ...
    internal const string GameSteamAppId = "361420";
    ...
    public static IReadOnlyList<GameInstallation> Discover()
    {
        ...
        var savedRoot = Path.Combine(localData, "Astro", "Saved");
        ...
        string paksRoot)
    {
        ...
        foreach (var rawLibrary in steamLibraries)
        {
            ...
            var executable = Path.Combine(root, "Astro.exe");
            ...
            var metadata = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                [PaksRootPathKey] = Path.GetFullPath(paksRoot),
