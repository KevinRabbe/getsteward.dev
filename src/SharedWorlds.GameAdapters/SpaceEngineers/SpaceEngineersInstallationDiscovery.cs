...
internal static partial class SpaceEngineersInstallationDiscovery
{
    ...
    internal const string GameSteamAppId = "244850";
    ...
    public static IReadOnlyList<GameInstallation> Discover()
    {
        ...
        return DiscoverFromSteamLibraries(
            ...
            Path.Combine(roaming, "SpaceEngineers", "Saves"));
    }
        ...
        string saveProfilesRoot)
    {
        ...
        foreach (var rawLibrary in steamLibraries)
        {
            ...
            var executable = Path.Combine(root, "Bin64", "SpaceEngineers.exe");
