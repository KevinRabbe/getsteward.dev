...
internal static partial class PlanetCrafterInstallationDiscovery
{
    ...
    internal const string GameSteamAppId = "1284190";
        ...
        string worldRoot)
    {
        ...
        foreach (var rawLibrary in steamLibraries)
        {
            ...
            var executable = Path.Combine(root, "Planet Crafter.exe");
