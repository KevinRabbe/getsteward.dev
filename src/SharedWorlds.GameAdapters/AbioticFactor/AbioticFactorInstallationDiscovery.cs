...
internal static partial class AbioticFactorInstallationDiscovery
{
    ...
    internal const string Ue4SsRootPathKey = "ue4ssRootPath";
    ...
    public static IReadOnlyList<GameInstallation> Discover()
    {
        ...
        return DiscoverFromSteamLibraries(
            ...
            Path.Combine(localData, "AbioticFactor", "Saved", "SaveGames"));
    }
        ...
        string saveGamesRoot)
    {
        ...
        foreach (var rawLibrary in steamLibraries)
        {
            ...
            var metadata = new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                [Ue4SsRootPathKey] = Path.GetFullPath(Path.Combine(
                    root,
                    "AbioticFactor",
                    "Binaries",
                    "Win64")),
