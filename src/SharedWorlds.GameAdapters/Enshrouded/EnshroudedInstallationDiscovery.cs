...
internal static partial class EnshroudedInstallationDiscovery
{
    ...
    internal const string GameSteamAppId = "1203620";
    ...
    public static IReadOnlyList<GameInstallation> Discover()
    {
        ...
        var saveGamesRoot = Path.Combine(userProfile, "Saved Games", "enshrouded");
        ...
        string saveGamesRoot)
    {
        ...
        foreach (var rawLibrary in steamLibraries)
        {
            ...
            var executable = Path.Combine(root, "enshrouded.exe");
